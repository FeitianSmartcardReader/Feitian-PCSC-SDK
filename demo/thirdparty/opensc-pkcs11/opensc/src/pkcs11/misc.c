...
static CK_RV sc_to_cryptoki_error_common(int rc)
{
	...
	case SC_ERROR_INVALID_ARGUMENTS:
		sc_log(context, "sc_to_cryptoki_error: SC_ERROR_INVALID_ARGUMENTS -> CKR_ARGUMENTS_BAD (0x07)");
		OPENSC_LOGD("sc_to_cryptoki_error: SC_ERROR_INVALID_ARGUMENTS -> CKR_ARGUMENTS_BAD (0x07)");
